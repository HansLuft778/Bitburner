...
/** @param {NS} ns */
export function hackServer(ns, target, host, threshold) {
	...
	if (numThreadsOnHost < hackThreads)
		throw new Error("can't onehit hack on server " + target + ".\nneed " + hackThreads + " Threads, only got " + numThreadsOnHost)
